...
**WUDataset** is a neural pedestrian inertial navigation corpus collected with a Google Pixel 6A IMU (200 Hz), a Vicon optical system (100 Hz), and a LiDAR-SLAM rig (200 Hz), synchronized via a custom Android app.
...
3. If you use this dataset in your work, please cite the following:
   ...
   @misc{Wu2025WUDataset,
     ...
     year = {2025},
     note = {MIT License},
     url = {INSERT-GOOGLE-DRIVE-LINK-HERE}
   }
